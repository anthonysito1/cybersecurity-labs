...
This is a collection of some of the highlights. Please feel free to look at my profile and see the dozens of other labs and LetsDefend cases I've done. 
...
*   **Related MITRE ATT&CK Framework:** Brute Force: Brute Force: Password Guessing (T1110.001), RDP: Remote Services: Remote Desktop Protocol (T1021.001)
...
*   **Related MITRE ATT&CK Framework:** User Execution: User Execution: Malicious File (T1204.002), C2 Connection: Application Layer Protocol (T1071), Scheduled Task: Scheduled Task/Job: Scheduled Task (T1053.005)
*   **Key Skills Demonstrated:**
...
*   **Related MITRE ATT&CK Framework:** RDP: Remote Services: Remote Desktop Protocol (T1021.001), Execution: Command and Scripting Interpreter: Powershell (T1059.001), Obfuscation: Obfuscated Files or Information: Command Obfuscation (T1027.010)
*   **Key Skills Demonstrated:**
...
*   **Related MITRE ATT&CK Framework:** Stealth: Indicatory Removal (T1070)
*   **Key Skills Demonstrated:**
...
*   **Related MITRE ATT&CK Framework:** Phishing Link: Phishing: Malicious Link (T1566.002), User Execution: User Execution: Malicious File (T1204.002), C2 Connection: Application Layer Protocol (T1071)
*   **Key Skills Demonstrated:**
...
*   **Related MITRE ATT&CK Framework:** Stealth/Execution: Hijack Execution Flow: Path Interception by Unquoted Path (T1574.009), Execution: Command and Scripting Interpreter: Powershell (T1059)
*   **Key Skills Demonstrated:**
